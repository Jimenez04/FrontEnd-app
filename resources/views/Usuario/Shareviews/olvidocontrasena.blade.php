            ...
            <div class="contenedor-olvidopw">
                <div class="container_olvido_contra">
                    ...
                    <div class="contenedor-correoalter">
                        ...
                        <input class="campos_recuperar_cuenta" type="email" value="{{ old('email') }}" name="email" required placeholder="Correo" title="Digite su correo institucional">
                        
                    </div>
                    <div class="container_carnet">
                        <input class="campos_recuperar_cuenta" type="text" value="{{ old('carnet') }}" name="carnet" required placeholder="Carnet" title="El carnet es requerido">
                    </div>
                    <div class="container_cedula">
                        <input class="campos_recuperar_cuenta" type="text" value="{{ old('cedula') }}" name="cedula" required placeholder="Cedula" title="Debe digitar su cédula">
                    </div>
