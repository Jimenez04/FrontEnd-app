                    ...
                    <form action="{{ route('PAI.store') }}" method="post" enctype="multipart/form-data">
                        ...
                        <div id="form_contenedor">
                            <div class="contenido_nueva_adecuacion pai-contenedor">
                                <div class="datos_adecuacion pai">
                                    ...
                                    <input id="nombre_Curso" title="Mínimo 5 caracteres" name="nombre_Curso"
                                        value="{{ old('nombre_Curso') }}" type="text" class="campos_adecuacion pai-input">
                                </div>
                                <div class="datos_adecuacion pai">
                                ...
                                <div class="datos_adecuacion pai">
                                    <label class="etiqueta_solicitud_adecuacion">Ingrese el número de matriculas al
                                        curso</label>
                                ...
                                <div class="datos_adecuacion pai">
                                    <label class="etiqueta_solicitud_adecuacion">Considero que las razones por las cuales no
                                        he podido aprobar el curso son:</label>
                                    <textarea type="text" id="resumen_No_Aprobar_El_Curso" name="resumen_No_Aprobar_El_Curso" title="Mínimo 4 caracteres"
                                        class="campos_adecuacion pai-input pai-area" {{-- cols="30" rows="10" --}}>
                                        {{ old('resumen_No_Aprobar_El_Curso') }}
                                    </textarea>
                                </div>
                                <div class="datos_adecuacion pai">
                                    <label class="etiqueta_solicitud_adecuacion">Ingrese el número de grupo del
                                        curso</label>
                                ...
                                <div class="datos_adecuacion pai">
                                    ...
                                    <input type="text" id="docente" name="docente" title="Mínimo 4 caracteres"
                                        value="{{ old('docente') }}" class="campos_adecuacion pai-input">
                                </div>
                                <div class="datos_adecuacion pai">
