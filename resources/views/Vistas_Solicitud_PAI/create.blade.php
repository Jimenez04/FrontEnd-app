                            ...
                            <div class="contenido_nueva_adecuacion">
                                ...
                                <div class="datos_adecuacion">
                                    ...
                                    <input type="number" id="semestre" min="1" max="3" name="semestre"
                                        title="Semestre" value="{{ old('semestre', 1) }}" class="campos_adecuacion">
                                </div>
                                <div class="datos_adecuacion">
                                    ...
                                    <input type="number" id="numero_De_Matriculas" min="2" max="100"
                                        ...
                                        value="{{ old('numero_De_Matriculas', 2) }}" class="campos_adecuacion">
                                </div>
                                <div class="datos_adecuacion">
                                    ...
                                    <textarea type="text" id="resumen_No_Aprobar_El_Curso" name="resumen_No_Aprobar_El_Curso" title="Mínimo 4 caracteres"
                                        class="campos_adecuacion" cols="30" rows="10">
